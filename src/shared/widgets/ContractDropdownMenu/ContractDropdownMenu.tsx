...
const ContractDropdownMenu = ({ contract }: any) => {
  ...
  const handleActionClick = (action: string) => {
    ...
    switch (action) {
      ...
      case "View Work Details":
        router.push(`/contracts/${id}/work-details`);
        break;
      case "Request a Refund":
        setShowRefundRequestModal(true);
        break;
      case "Open a Dispute":
        router.push(`/contracts/${id}/dispute`);
        break;
      default:
  ...
  const handleEndContract = (action: string) => {
    ...
    if (action === "end-contract") {
      ...
      router.push(`/contracts/${id}/end-contract`);
    }
  };
    ...
    <>
      ...
      {showRefundRequestModal && (
        <GlobalModal
          ...
          classes="xl:w-[776px] md:w-[556px] w-[335px] xl:h-[683px] md:h-[687px] h-[707px] md:px-[38px]  px-[24px] xl:py-[28px] md:py-[25px] py-[21px]"
        >
