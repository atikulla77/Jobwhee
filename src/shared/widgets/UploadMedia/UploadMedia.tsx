	...
	return (
		<div className="mt-[17px] sm:mt-[16px] 2xl:mt-[20px]">
			...
			<input
				...
				className="hidden"
			/>
			<div className="relative lg:max-w-[595px] min-h-[270px] w-full flex items-center justify-center flex-col rounded-[12px] mt-[7px] lg:mt-[7px] 2xl:mt-[11px] sm:pt-[4px] lg:sm:pt-[21px] 2xl:pt-0 lg:pt-0 border border-dashed border-[#AEB3BC]">
				{selectedImagePreview ? (
					<div className="flex flex-col items-center justify-center 2xl:mt-[18px] 2xl:mb-[24px] gap-[20px]">
						<img
					...
					<div className="flex flex-col items-center">
						<div className="relative w-[92px] h-[86px] flex justify-center items-center lg:mt-[4px] 2xl:mt-[28px] border border-dashed border-[#AEB3BC] rounded-[5px]">
