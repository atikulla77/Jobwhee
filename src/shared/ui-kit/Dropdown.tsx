...
const Dropdown: React.FC<DropdownProps> = ({
  ...
  selectedItem,
  setSelectedItem,
  width = "lg:min-w-[350px] sm:min-w-[300px] min-w-[250px] w-full",
}) => {
  const inputId = useId();
    ...
    <ClickOutside onClick={() => setOpenMenu(false)}>
      <div className={`${width}`}>
        ...
        <div className="relative">
          ...
          >
            <div
              className={` items-center select-none w-full min-h-[24px] text-[16px] truncate block 2xl:placeholder:text-[16px] placeholder:text-[12px] sm:placeholder:text-[14px] focus:outline-0 ${
