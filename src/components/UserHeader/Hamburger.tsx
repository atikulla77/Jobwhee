        ...
        <ClickOutside onClick={() => setDropdownOpen(false)} className="relative">
            <div className="z-[201]">
                ...
                >
                    <Image
                        src={`${
                            dropdownOpen ? "/images/icon-images/closeIcon.png" : "/images/icon-images/hamburger.png"
                        }`}
                        alt={"Hamburger"}
                        width={38}
                        height={38}
                ...
                {dropdownOpen && (
                    <div
                        className="absolute flex flex-col -right-[75px] md:-right-[94px] overflow-y-auto max-h-[calc(100vh_-_65px)] mt-3 w-[100vw]  bg-white lg:shadow-lg rounded-md z-[201] ">
                        <ul className="py-2 pr-[10px] sm:pr-[20px] pt-[14px] sm:pt-[45px] sm:px-[40px] flex flex-col justify-start items-start w-full h-[100vh]">
                            ...
                            >
                                <div className="relative">
                                    {testNotifies && (
                                        <div
                                            className="absolute w-[5px] h-[5px] rounded-full top-0 right-[3px] bg-[#FF0000]"></div>
                                    )}
                                    {notifyVisible ? (
                                        <NotificationIcon/>
                                    ) : (
                            ...
                            {notifyVisible && (
                                <div className="mr-[10px] sm:mr-0">
                                    ...
                                    <div className="flex justify-center">
                                        <button
                                            className="ml-[10px] sm:ml-0 mt-[20px] text-[16px] font-medium text-[#18470D]">
                            ...
                            <li className="pl-[10px] sm:pl-0 w-full">
                                <div
                                    className="border-b border-[#EAEAEA] h-[54px] sm:h-[59px] px-4 py-2 hover:bg-gray-100 cursor-pointer flex justify-start items-center gap-[10px] w-full ">
                                    <Image
                                        src={"/icons/mail.png"}
                                        width={24}
                                        height={24}
                                ...
                                <div
                                    className="pl-[15px] sm:pl-[27px] pr-4 h-[48px] hover:bg-gray-100 cursor-pointer flex justify-start items-center font-medium gap-[10px] w-full text-[14px]">
