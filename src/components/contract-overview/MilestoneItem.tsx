    ...
    <div>
      ...
      {showPaymentModal && (
        <GlobalModal
          ...
          width="xl:w-[678px] md:w-[556px] w-[335px]"
          height="h-[687px]"
        >
          <>
      ...
      {showAddMilestoneModal && (
        <GlobalModal
		  ...
		  padding="md:px-[38px] px-[24px] xl:py-[24px] md:py-[38px] py-[24px]"
        >
          <>
      ...
      {showMilestoneModal && (
        <GlobalModal
		  ...
		  padding="xl:px-[38px] px-[24px] xl:py-[28px] py-[24px]"
        >
          <>
            ...
            <div className="xl:h-[536px] md:h-[392px] h-[440px] pt-[10px]  relative overflow-y-auto">
            ...
            <div className="w-[100%] h-[1px] bg-[#18470D]"></div>
