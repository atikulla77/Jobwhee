  ...
  return (
    <>
      <div className="w-full flex flex-wrap justify-between items-center relative">
        <h1 className="text-[20px] font-[500] text-[#000000] md:w-fit w-full">
          Milestone Timeline
        </h1>

        <div className="flex items-center md:gap-[10px] gap-0">
          <div className="md:relative absolute right-0 top-[-5px] w-[38px] h-[38px] border-[1px] border-[#CBEC5E] flex items-center justify-center rounded-[100%]">
            <RefundIcon />
          </div>
          <button className="text-[16px] font-[500] 2xl:w-[130px] w-[107px] h-[38px] border-[1px] border-[#CCCCCC] text-[#18470D] rounded-[50px] md:mt-0 mt-[13px]">
            Upload
          </button>
        </div>
      </div>
