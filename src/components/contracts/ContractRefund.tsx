  ...
  return (
    <div>
        ...
        <div className="xl:h-[620px] md:h-[841px] h-[958px] xl:rounded-[16px] md:rounded-[30px] rounded-[16px] border border-[#CBEC5E] 2xl:p-[28px] xl:p-[27px] md:p-[20px] p-[12px]">
          ...
          <div className="w-full flex xl:flex-row flex-col 2xl:gap-[107px] xl:gap-[83px] md:gap-[22px] gap-[34px] mb-2">
            ...
            <div className="2xl:w-[743px] xl:w-[583px] w-full ">
              <h3 className="text-[18px] xl:pb-[10px] md:pb-[20px] pb-[10px]">
                Note
              </h3>
              <p className="md:text-[16px] text-[14px]">
                I’m requesting a refund for the milestone payment of €500 made
                for the Hairstylist Needed for Special Events project due to
                <br className="md:hidden block" /> the following reasons:
                <br />
                Reason for Refund:
                <br />
                Incomplete Work:
                ...
                project scope. Specifically, the required hairstyling concepts
                and designs were not completed as agreed. The final deliverables
                didn’t reflect the style we discussed for the
                <br className="md:hidden block" /> special events, and some of
                the proposed styles were missing key details.
                <br />
                Delayed Delivery:
                <br />
                ...
                planning and <br className="2xl:hidden xl:block hidden" />{" "}
                caused significant delays in our project schedule.{" "}
                <br className="2xl:block hidden" />
                Please process the refund for the milestone amount of €500. Let
                me know if you have any questions or if further clarification is
                needed. I appreciate your prompt attention{" "}
                <br className="xl:hidden md:block hidden" />
                to this matter.
                <br />
                <br />
                Best regards,
      ...
      {showDeclineModal && setShowDeclineModal && (
        ...
        >
          <DeclineModal setShowDeclineModal={setShowDeclineModal} />
        </GlobalModal>
      )}
    </div>
  );
