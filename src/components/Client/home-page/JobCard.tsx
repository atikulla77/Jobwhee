    ...
    return (
        <div className="  relative h-full max-w-">
            ...
            <div className="flex justify-end relative h-[26px]  sm:h-[40px] lgh-[46px]">
                <div
                    className={`text-[12px] sm:text-[16px] absolute top-[13px] sm:top-[16px] right-[11px] sm:right-[23px] z-10 p-[4px_16px] rounded-[30px] ${
                        job.type === "draft"
            ...
            <div
                className=" h-full w-full pb-[19px] sm:pb-[30px] px-[12px] sm:px-[28px] sm:pr-[22px] lg:px-[22px] lg:pl-[29px] pt-[32px] sm:pt-[55px] 2xl:pt-[57px] 2xl:pl-[28px] rounded-[30px] relative rounded-tr-none ">
                <div className="flex">
                    <div
                        className="mr-[10px] sm:mr-[15px] min-w-[20px] sm:min-w-none w-[20px] h-[20px] sm:w-[30px] sm:h-[30px] lg:w-[48px] lg:h-[48px] flex justify-center items-center border border-[#CCCCCC] rounded-full">
              ...
              <div
                className="flex sm:justify-start sm:pl-[17px] lg:pl-0 gap-[12px] sm:gap-[23px] lg:justify-between 2xl:mt-[21px] sm:mt-[22px] mt-[15px] lg:mt-[25px]">
                ...
                <div>
                    <button
                        className="cursor-pointer text-[#18470D] text-[10px] sm:text-[16px] font-medium border border-[#CCCCCC] w-full h-[40px] rounded-full mt-[22px] sm:mt-[50px] lg:mt-[49px] 2xl:mt-[51px]">
                        Find Talent
                    </button>
                </div>
            </div>
