...
const CustomDatePicker: React.FC<DatePickerProps> = ({
  ...
  return (
    <div
      className={`border-[1px] rounded-[12px] h-[42px] p-[8px] flex items-center w-full max-w-[350px] ${isCalendarOpen ? ' border-[#18470D] blue-shadow ' : ''}`}
    >
      <div className="flex flex-col items-center space-y-4 w-full h-[48px]">
        <DatePicker
          ...
          className=" focus:outline-none outline-none flex-grow text-[#8B939F] text-[16px] font-medium block my-[12px] w-full placeholder:text-[#8B939F]"
