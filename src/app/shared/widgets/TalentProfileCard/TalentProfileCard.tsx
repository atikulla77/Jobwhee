...
const TalentProfileCard = (talentInfo: TalentProfileCardProps) => {
  return <Link href={`/client/${talentInfo.id}/talentPublicPage`}>
    <div
      className="p-[14px_20px] w-[285px] h-[403px] border border-[#EAEAEA] rounded-[20px] flex justify-center card-shadow">
      <div className="flex items-center flex-col">
        <div
          className="w-[113px] h-[113px] rounded-full overflow-hidden border-[2px] border-[#CBEC5E]">
          <Image
        ...
        <div className="flex gap-[8px] mt-[28px] sm:mt-[32px] lg:mt-[29px] 2xl:mt-[28px]">
          <button
            className="w-[149px] h-[40px] text-[#18470D] text-[16px] border border-[#CCCCCC] rounded-[50px] cursor-pointer font-medium">
            Rehire
          </button>
          <div
            className="w-[40px] h-[40px] border border-[#CCCCCC] rounded-full cursor-pointer flex justify-center items-center">
            <HeartIcon/>
          </div>
          <div
            className="w-[40px] h-[40px] border border-[#CCCCCC] rounded-full cursor-pointer flex justify-center items-center">
