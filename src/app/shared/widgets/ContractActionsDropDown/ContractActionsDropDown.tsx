    ...
    <div className="relative">
      {dropdownOpen && (
        <div className="absolute xl:!right-0 sm:right-[-113px] right-0 top-[12px] z-50">
          <ul className="bg-[#ffffff] rounded-[6px] p-2 shadow-[0px_3px_15px_0px_#e4e4e494] transition-all duration-200 w-[180px] sm:w-[269px] mt-1 relative">
            ...
            {menuOptions.map((option, index) => (
              <li key={index}>
                <button
                  className="w-full text-left px-4 sm:py-[10px] py-[6px] sm:text-[16px] text-[13px] font-[500] text-[#545454] rounded-md"
